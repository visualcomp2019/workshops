...
void setup() {
  ...
  output = createWriter("softwareImg_fps.txt");
...
void draw() {
  ...
  switch(option){
    case 1:
      ...
      conv = convolution(blurKernel, img, 3);     
      break;
    case 2:
      //Apply sharpen convolution kernel
      conv = convolution(sharpenKernel, img, 3);
      break;
    case 3:
      //Apply edge convolution kernel
      conv = convolution(edgeKernel, img, 3);
      break;
    default:
      //original
      conv = convolution(identityKernel, img, 3);
      break;
  }
  pg2.beginDraw();
